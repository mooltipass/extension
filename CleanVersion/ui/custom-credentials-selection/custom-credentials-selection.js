...
cipDefine.initDescription = function () {
    ...
    var $btnSkip = mpJQ("<button>").text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Button_Skip")).attr("id", "mp-bt-btn-skip")
    ...
    var $btnCancel = mpJQ("<button class='alert tiny'>").text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Button_Cancel")).attr("id", "mp-bt-btn-cancel").attr("href", '#')
        .click(function (e) {
    ...
    var $btnConfirm = mpJQ("<button class='success tiny'>").text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Button_Confirm")).attr("id", "mp-bt-btn-confirm")
...
cipDefine.markAllUsernameFields = function () {
    cipDefine.eventFieldClick = function (e) {
        ...
        mpJQ(this).addClass("mp-bt-fixed-username-field").text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Label_Username")).unbind("click");
        cipDefine.prepareStep2();
        cipDefine.markAllPasswordFields(mpJQ("#mp-bt-cipDefine-fields"));
    };
...
cipDefine.markAllPasswordFields = function () {
    cipDefine.eventFieldClick = function (e) {
        ...
        mpJQ(this).addClass("mp-bt-fixed-password-field").text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Label_Password")).unbind("click");
        cipDefine.prepareStep3();
    };
...
cipDefine.prepareStep1 = function () {
    ...
    mpJQ("div:first", mpJQ("div#mp-bt-cipDefine-description")).text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Step_1"));
...
cipDefine.prepareStep2 = function () {
    ...
    mpJQ("div:first", mpJQ("div#mp-bt-cipDefine-description")).text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Step_2"));
...
cipDefine.prepareStep3 = function () {
    ...
    mpJQ("div:first", mpJQ("div#mp-bt-cipDefine-description")).text(chrome.i18n.getMessage("CustomCredentialsSelectionHtml_Step_3"));
}
