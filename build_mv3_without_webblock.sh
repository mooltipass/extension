...
cp "${SOURCE_DIR}/manifest_withoutwebblocking.json" "${BUILD_DIR}/manifest.json"
...
mv "${BUILD_DIR}/background/init_withoutwebblocking.js" "${BUILD_DIR}/background/init.js"
rm "${BUILD_DIR}/background/init_webblocking.js"
